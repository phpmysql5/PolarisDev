...
import FBURL from '@salesforce/schema/Account.Facebook_Page_URL_c__c';
...
export default class Facebooktimeline extends LightningElement {
    ...
    get facebookSrc() {
        if( typeof this.Account.data !== 'undefined' ){
            return 'https://www.facebook.com/plugins/page.php?href='+this.Account.data.fields.Facebook_Page_URL_c__c.value+
